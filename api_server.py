...
# Pydantic defines the shape of our request and response data python server code
...
def call_llm(prompt: str, model: str) -> str:
    ...
    response = openrouter_client.chat.completions.create(
        ...
        extra_headers={
            "HTTP-Referer": "http://localhost:8000",  # identifies your app to OpenRouter
            "X-Title": "TML Bootcamp RAG"             # shows up in your OpenRouter dashboard
        }
    )
